"""Safely explore same-origin pages through explicit runner phases.

The browser script excludes destructive actions and returns bounded rendered
page evidence. The template retains that evidence for product review without
claiming that the pages themselves were changed.
"""
